...
public class ContoOnline extends ContoCorrente implements Servizio {
    private Cliente cliente;
    private String iban;
    private Boolean fido = Boolean.FALSE;
    private Float saldo;
    private Float costoAnnuo = 30f;
    private Integer costoOperazione = 1;
    private Integer valoreMinSaldo = -1000;

    public ContoOnline(Cliente cliente, String iban, Float saldo) {
    ...
    public boolean equals(Object o) {
        ...
        ContoOnline that = (ContoOnline) o;
    ...
    public void bonifico(Float importo, ContoStandard contoStandard) {
        if (prelievo(importo).equals(importo)) {
            this.setSaldo(saldo+costoOperazione);
